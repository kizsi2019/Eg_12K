    ...
    internal class Program
    {
        class Ember
        {
            ...
            public int Életkor
            {
                ...
                set
                {
                    if (value >= 0) életkor = value; else Exception("Az életkor mező nem lehet negatív");
                }
            }
            ...
            public int Irányítószám
            {
                ...
                set
                {
                    if (value.ToString().Length == 4) irányítószám = value; else Exception("Az irányítószám mező helytelen!");
                }
            }
